...
public class ManulRenderer extends MobRenderer<ManulEntity, ManulRenderState, ManulModel> {
	private static final ResourceLocation TEXTURE = ManulMod.id("textures/entity/manul.png");
	/** Рыжий окрас: та же развёртка, перекрашенная генератором. */
	private static final ResourceLocation TEXTURE_GINGER = ManulMod.id("textures/entity/manul_ginger.png");
	...
	@Override
	public ResourceLocation getTextureLocation(ManulRenderState state) {
